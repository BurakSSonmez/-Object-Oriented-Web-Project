...
public class Finall {
    ...
    public Finall(int sampiyon_id, String takim_adi, String ulkesi) {
    ...
    public void setSampiyon_id(int samyion_id) {
        this.sampiyon_id = sampiyon_id;
    }
    ...
    public String toString() {
        return "Final{" + "sampiyon_id=" + sampiyon_id + ", takim_adi=" + takim_adi + ", ulkesi=" + ulkesi +'}';
    }
}
