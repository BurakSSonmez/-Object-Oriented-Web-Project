...
public class Oyuncular {
    ...
    public Oyuncular(int oyuncu_id, String adi_soyadi, String mevki, String takimi) {
    ...
    public String toString() {
        return "Oyuncular{" + "oyuncu_id=" + oyuncu_id + ", adi_soyadi=" + adi_soyadi + ", mevki=" + mevki + ", takimi=" + takimi + '}';
    }
}